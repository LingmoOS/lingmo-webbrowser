...
class SettingsData(QQuickItem):
    for i in data['../resources/data/settings.json']:
        ...
        exec(i+"=Property(type(Data('../resources/data/settings.json','"+i+"')),(lambda self: Data('../resources/data/settings.json','"+i+"')),(lambda self,val: dumpData('../resources/data/settings.json','"+i+"',val)),notify="+i+"Changed)")
